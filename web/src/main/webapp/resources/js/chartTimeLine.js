function cargaTimeLineChart(url) {

// Themes begin
am4core.useTheme(am4themes_animated);
// Themes end

var chart = am4core.create("chartTimeLinediv", am4plugins_timeline.SerpentineChart);
...
chart.data = [{
	...
	"disabled2":false,
    "image1":"/wp-content/uploads/assets/timeline/rachel.jpg",
    "location":0
}, {
    "category": "Module #3",
    "start": "2019-03-10",
...
dateAxis.renderer.line.strokeDasharray = "0";
